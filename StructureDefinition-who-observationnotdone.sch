...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile CPGObservation
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Observation">
      ...
      <sch:assert test="count(f:extension[@url = 'http://fhir.org/guides/who/core/StructureDefinition/who-notDoneReason']) &gt;= 1">extension with URL = 'http://fhir.org/guides/who/core/StructureDefinition/who-notDoneReason': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.org/guides/who/core/StructureDefinition/who-notDoneReason']) &lt;= 1">extension with URL = 'http://fhir.org/guides/who/core/StructureDefinition/who-notDoneReason': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Observation/f:modifierExtension</sch:title>
