...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile WHOServiceNotRequested
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:ServiceRequest">
      ...
      <sch:assert test="count(f:extension[@url = 'http://fhir.org/guides/who/core/StructureDefinition/who-doNotPerformReason']) &gt;= 1">extension with URL = 'http://fhir.org/guides/who/core/StructureDefinition/who-doNotPerformReason': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.org/guides/who/core/StructureDefinition/who-doNotPerformReason']) &lt;= 1">extension with URL = 'http://fhir.org/guides/who/core/StructureDefinition/who-doNotPerformReason': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
