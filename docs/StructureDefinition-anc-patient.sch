...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      ...
      <sch:assert test="count(f:extension[@url = 'http://fhir.org/guides/who/anc-cds/StructureDefinition/reminder']) &gt;= 1">extension with URL = 'http://fhir.org/guides/who/anc-cds/StructureDefinition/reminder': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.org/guides/who/anc-cds/StructureDefinition/reminder']) &lt;= 1">extension with URL = 'http://fhir.org/guides/who/anc-cds/StructureDefinition/reminder': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.org/guides/who/anc-cds/StructureDefinition/educationlevel']) &gt;= 1">extension with URL = 'http://fhir.org/guides/who/anc-cds/StructureDefinition/educationlevel': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.org/guides/who/anc-cds/StructureDefinition/educationlevel']) &lt;= 1">extension with URL = 'http://fhir.org/guides/who/anc-cds/StructureDefinition/educationlevel': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.org/guides/who/anc-cds/StructureDefinition/occupation']) &gt;= 1">extension with URL = 'http://fhir.org/guides/who/anc-cds/StructureDefinition/occupation': minimum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
