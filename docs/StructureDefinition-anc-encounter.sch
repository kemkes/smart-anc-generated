...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile ANCBaseEncounter
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Encounter">
      ...
      <sch:assert test="count(f:extension[@url = 'http://fhir.org/guides/who/anc-cds/StructureDefinition/contactnumber']) &gt;= 1">extension with URL = 'http://fhir.org/guides/who/anc-cds/StructureDefinition/contactnumber': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.org/guides/who/anc-cds/StructureDefinition/contactnumber']) &lt;= 1">extension with URL = 'http://fhir.org/guides/who/anc-cds/StructureDefinition/contactnumber': maximum cardinality of 'extension' is 1</sch:assert>
